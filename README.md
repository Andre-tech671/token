...
├── README.md
└── src/
    ├── token_backend/          # Backend Motoko code
    │   └── main.mo
    └── token_frontend/         # Frontend React application
        ...
        └── src/
            ...
            │   ├── Balance.jsx # Balance check component
            │   └── Transfer.jsx # Token transfer component
            └── tests/
                └── App.test.jsx
```
...
```bash
cd src/token_frontend
npm install
npm run dev
```

This will start a development server at `http://localhost:5173` (or similar port).
